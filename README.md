...
Cute virtual pet app with local care meters, mood changes, and playful actions.

- Live website: https://snakeeye-sudo.github.io/Paltu-Sathi/
- Family hub: https://snakeeye-sudo.github.io/Aapka-Sathi/
- GitHub repo: https://github.com/SnakeEye-sudo/Paltu-Sathi
- Tags: sathi-family, virtual-pet, casual-game, pet-care, pwa, hindi-app
