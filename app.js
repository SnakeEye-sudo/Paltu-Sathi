...
(() => {
  ...
  `;
    ...
    function renderJournal() {
      journalList.innerHTML = state.journal.length ? state.journal.map((entry) => `<div class="history-card"><strong>${entry}</strong><span class="muted">Care memory</span></div>`).join("") : '<div class="history-card"><strong>Journal ready hai</strong><span class="muted">Actions se cute updates yahan aayenge.</span></div>';
    }
    function render() {
